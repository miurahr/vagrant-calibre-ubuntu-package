...
$build = <<BUILD
wget -c http://archive.ubuntu.com/ubuntu/pool/main/p/pyqt5/pyqt5_5.3.1+dfsg-4.dsc
wget -c http://archive.ubuntu.com/ubuntu/pool/main/p/pyqt5/pyqt5_5.3.1+dfsg.orig.tar.gz
wget -c http://archive.ubuntu.com/ubuntu/pool/main/p/pyqt5/pyqt5_5.3.1+dfsg-4.debian.tar.xz
dpkg-source -x pyqt5_5.3.1+dfsg-4.dsc
cd pyqt5-5.3.1+dfsg
debuild -us -uc -b -i
cd ..
